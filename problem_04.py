...
class Bank:
    ...
    def transfer(self, from_account, to_account, amount):
        # o withdraw não verificava se o saldo era menor ou maior que o montante, então o código executava a transferência mesmo se a conta de origem não tivesse saldo suficiente
...
def main():
    ...
    # Create accounts
    alice_account = Account("A001", 100)
